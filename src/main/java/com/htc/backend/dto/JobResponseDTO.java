...
public class JobResponseDTO {
    ...
    public JobResponseDTO(Long jobId, Long employerUserId, String title, String description,
                          String jobType, String requirements, String salaryRange, String status, LocalDate postedDate) {
        this.jobId = jobId;
